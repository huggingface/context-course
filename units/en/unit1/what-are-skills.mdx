...
In this lesson, we'll explore skills in depth: what they are, why they matter, and how they solve real problems for code agent users.

## The Problem: Agents Without Context

Let's start with a concrete failure case. Imagine you're working on the Hugging Face Hub and ask your code agent:
...
Now that you understand what skills are, let's examine how they're structured. In the next lesson, we'll look at the anatomy of a skill file — the SKILL.md format — and then move on to building your first skill and using it in a real project.
