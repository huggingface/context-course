...
We'll use the [hf-cli](https://github.com/huggingface/skills/blob/main/skills/hf-cli/SKILL.md) skill as a real-world example. It gives agents access to the Hugging Face Hub CLI for downloading, uploading, and managing repositories.
