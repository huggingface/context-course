...
![Hook event flow from agent runtime through HTTP to a Gradio dashboard](https://huggingface.co/datasets/mcp-course/images/resolve/main/unit5/hooks-dashboard-flow.svg)
