#!/usr/bin/env python3
"""Print a Pi kickoff prompt for inference optimization."""
...
Then run the project prompt template:
/inference-lab "{target}" {max_candidates}

Equivalent parent prompt:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Print a Pi kickoff prompt for inference optimization."
    )
    parser.add_argument(
        "--target",
